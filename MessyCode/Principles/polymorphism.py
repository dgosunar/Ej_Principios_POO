...
def polyExample():
    ...
    print('''          <<< El polimorfismo es darle "muchas formas" a un atributo o método en diferentes clases \n\r( ^o^)_/       teniendo el mismo nombre pero dándoles un valor o funcionalidad diferente. >>>\n\r''')

    print("--> Para el ejemplo crearemos 4 instancias, una de la clase padre 'Player' y otras tres\n\rinstancias de cada una de las clases hijas de 'Player'.")
    ...
    print("\n\r* El player7 es de tipo 'Player' con id:", player7.getId(), 'y nombre:', player7.name)
    print("* El player8 es de tipo 'Fighter' con id:", player8.getId(), ', nombre:', player8.name, 'y tipo de fuerza:', player8.fightForce)
    print("* El player9 es de tipo 'Wizard' con id:", player9.getId(), ', nombre:', player9.name, 'y tipo de magia:', player9.magicType)
    print("* El player10 es de tipo 'Healer' con id:", player10.getId(), ', nombre:', player10.name, 'y herramienta de sanación:', player10.healTool)
