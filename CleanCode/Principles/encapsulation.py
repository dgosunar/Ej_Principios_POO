...
def enExample():
    ...
    print(
        "Encontramos que el atributo 'id' es privado. Por lo tanto no tenemos acceso a este y nos genera un error."
    )
    try:
