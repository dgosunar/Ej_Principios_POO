...
def absExample():
    ...
    print(
        """          <<< La abstracción nos permite simplificar entidades complejas representándolas \n\r( ^o^)_/      mediante atributos (cómo se "ven") y métodos (qué "hacen"). >>>\n\r"""
    )

    print(
        "Por ejemplo, creamos una instancia de la clase 'Player' para describir a un jugador de videojuegos.\n\r"
    )
